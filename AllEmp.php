...
$sqlee = "SELECT emp_no,first_name,last_name,gender,hire_date,birth_date FROM employees";

$sql1= mysqli_query($conn, $sqlee);

$nr = mysqli_num_rows($sql1); // Get total of Num rows from the database query
...
$sqlll = "SELECT emp_no,first_name,last_name,gender,hire_date,birth_date FROM employees ORDER BY emp_no DESC $limit";
$sql22= mysqli_query($conn, $sqlll);
